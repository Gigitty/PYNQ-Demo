...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ DEMO 6/PYNQ DEMO 6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder_Design_wrapper.tcl -notrace
