...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ DEMO 6/PYNQ DEMO 6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_Design_wrapper.tcl
