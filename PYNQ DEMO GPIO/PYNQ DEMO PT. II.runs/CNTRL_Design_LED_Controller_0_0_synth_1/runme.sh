...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ DEMO PT. II/PYNQ DEMO PT. II.runs/CNTRL_Design_LED_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNTRL_Design_LED_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CNTRL_Design_LED_Controller_0_0.tcl
