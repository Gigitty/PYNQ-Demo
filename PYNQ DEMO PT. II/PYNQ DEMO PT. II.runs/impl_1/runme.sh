...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ DEMO PT. II/PYNQ DEMO PT. II.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CNTRL_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CNTRL_Design_wrapper.tcl -notrace
