...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ DEMO PT. II/PYNQ DEMO PT. II.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNTRL_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CNTRL_Design_wrapper.tcl
