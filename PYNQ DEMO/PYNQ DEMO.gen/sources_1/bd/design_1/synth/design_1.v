...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=16,da_board_cnt=12,da_bram_cntlr_cnt=8,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [12:0]bram_BRAM_PORTA_ADDR;
  wire bram_BRAM_PORTA_CLK;
  wire [31:0]bram_BRAM_PORTA_DIN;
  wire [31:0]bram_BRAM_PORTA_DOUT;
  wire bram_BRAM_PORTA_EN;
  wire bram_BRAM_PORTA_RST;
  wire [3:0]bram_BRAM_PORTA_WE;
  wire [12:0]bram_BRAM_PORTB_ADDR;
  wire bram_BRAM_PORTB_CLK;
  wire [31:0]bram_BRAM_PORTB_DIN;
  wire [31:0]bram_BRAM_PORTB_DOUT;
  wire bram_BRAM_PORTB_EN;
  wire bram_BRAM_PORTB_RST;
  wire [3:0]bram_BRAM_PORTB_WE;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > design_1 bram_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_axi_bram_ctrl_0_0 bram
       (.bram_addr_a(bram_BRAM_PORTA_ADDR),
        .bram_addr_b(bram_BRAM_PORTB_ADDR),
        .bram_clk_a(bram_BRAM_PORTA_CLK),
        .bram_clk_b(bram_BRAM_PORTB_CLK),
        .bram_en_a(bram_BRAM_PORTA_EN),
        .bram_en_b(bram_BRAM_PORTB_EN),
        .bram_rddata_a(bram_BRAM_PORTA_DOUT),
        .bram_rddata_b(bram_BRAM_PORTB_DOUT),
        .bram_rst_a(bram_BRAM_PORTA_RST),
        .bram_rst_b(bram_BRAM_PORTB_RST),
        .bram_we_a(bram_BRAM_PORTA_WE),
        .bram_we_b(bram_BRAM_PORTB_WE),
        .bram_wrdata_a(bram_BRAM_PORTA_DIN),
        .bram_wrdata_b(bram_BRAM_PORTB_DIN),
  ...
  design_1_bram_bram_0 bram_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,bram_BRAM_PORTA_ADDR}),
        .addrb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,bram_BRAM_PORTB_ADDR}),
        .clka(bram_BRAM_PORTA_CLK),
        .clkb(bram_BRAM_PORTB_CLK),
        .dina(bram_BRAM_PORTA_DIN),
        .dinb(bram_BRAM_PORTB_DIN),
        .douta(bram_BRAM_PORTA_DOUT),
        .doutb(bram_BRAM_PORTB_DOUT),
        .ena(bram_BRAM_PORTA_EN),
        .enb(bram_BRAM_PORTB_EN),
        .rsta(bram_BRAM_PORTA_RST),
        .rstb(bram_BRAM_PORTB_RST),
        .wea(bram_BRAM_PORTA_WE),
        .web(bram_BRAM_PORTB_WE));
  design_1_axi_gpio_0_1 buttons
  ...
  (* BMM_INFO_PROCESSOR = "arm > design_1 bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  design_1_axi_gpio_0_2 switches
