...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DEMO PT . III/PYNQ_DEMO PT . III.runs/Clk_Div_Clock_Divider_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clk_Div_Clock_Divider_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clk_Div_Clock_Divider_1_2.tcl
