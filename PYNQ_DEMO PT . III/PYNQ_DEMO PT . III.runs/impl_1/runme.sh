...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DEMO PT . III/PYNQ_DEMO PT . III.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Clk_Div_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Clk_Div_wrapper.tcl -notrace
