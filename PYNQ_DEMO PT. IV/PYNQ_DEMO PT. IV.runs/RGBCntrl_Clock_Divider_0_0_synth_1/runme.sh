...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DEMO PT. IV/PYNQ_DEMO PT. IV.runs/RGBCntrl_Clock_Divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGBCntrl_Clock_Divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGBCntrl_Clock_Divider_0_0.tcl
