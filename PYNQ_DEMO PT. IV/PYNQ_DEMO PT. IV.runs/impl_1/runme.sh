...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DEMO PT. IV/PYNQ_DEMO PT. IV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RGBCntrl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RGBCntrl_wrapper.tcl -notrace
