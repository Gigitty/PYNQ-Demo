...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DEMO PT. IV/PYNQ_DEMO PT. IV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGBCntrl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGBCntrl_wrapper.tcl
