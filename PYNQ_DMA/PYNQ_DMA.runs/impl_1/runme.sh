...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DMA/PYNQ_DMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DMA_Design_wrapper.tcl -notrace
