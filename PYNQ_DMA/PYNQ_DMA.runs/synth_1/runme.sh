...
HD_PWD='C:/Users/abous/OneDrive/Documents/GitHub/PYNQ Demo/PYNQ_DMA/PYNQ_DMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_Design_wrapper.tcl
